---
title: Safariを「令和のIE」と風刺することより知っておくべきブラウザの問題
...
## 風刺よりも知っておくべき今のブラウザの問題点

SafariがかつてのIEの状況と似ている点に触れてみましたが、ブラウザベンダ間で共同して解消していけることや、デバイスの定期購入などで、風刺するための強い要因になるとは言い切れませんでした。

そうした風刺をするよりも、ブラウザに関わるものとしてそれ以外での懸念すべき今の問題においても目を向けるべきだと私は思っています。
...
Chromiumをフォークして新たなブラウザエンジンを作る方向性もあるかもしれません。ですが、EdgeがChromiumベースになっていたり、新たに産まれたブラウザの[Arc](https://arc.net/)もChromiumベースになっているものがあることを考えると、新たなエンジンを元にブラウザを作ることは到底できないように感じています。
