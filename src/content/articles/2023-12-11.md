...
Tailwind CSSがCSS表現をロックインしてしまい他の技術へ移行することができない技術的負債になるのではないかと懸念する声もあります。ですが私はそこまで懸念されるほどのものなのかがピンと来ていません。もしTailwind CSSを除去する場合は依存するクラス名だけを抽出して削除することで他画面には影響なく安心して消すことができるはずなので、むしろ取り扱うのは容易な方なのではないかと思っています。
