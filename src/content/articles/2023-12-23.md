...
Browser compatibility自体はそのまま残しつつ、主要ブラウザの最新２メジャーverでどこまでサポートされているかを確認しやすくなりました。MDNドキュメントやweb.devにて展開されてるようになっています。現在は[Can I Useでも表示される](https://caniuse.com/feed/166)ようになりました。
